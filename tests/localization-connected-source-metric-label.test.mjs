...
test("localizeConnectedSourceMetricLabel localizes known official metric labels in Korean", () => {
  ...
  assert.equal(localization.localizeConnectedSourceMetricLabel("ko", "Auction volume"), "경매 물량");
  ...
  assert.equal(localization.localizeConnectedSourceMetricLabel("ko", "20d avg volume"), "20일 평균 거래량");
  assert.equal(localization.localizeConnectedSourceMetricLabel("ko", "Annual turnover"), "연간 거래대금");
});

test("localizeConnectedSourceMetricLabel keeps English metric labels unchanged", () => {
  assert.equal(localization.localizeConnectedSourceMetricLabel("en", "Auction price"), "Auction price");
...
test("localizeConnectedSourceMetricLabel falls back to the raw label when it is unknown", () => {
  assert.equal(localization.localizeConnectedSourceMetricLabel("ko", "Unmapped metric"), "Unmapped metric");
});
