...
- Evidence in code:
  - [App.tsx](../src/App.tsx)
  - [research.ts](../src/data/research.ts)
  - [liveSources.js](../electron/liveSources.js)
...
- Current product treatment:
  - market-level driver library in [research.ts](../src/data/research.ts)
  - factor decomposition board in [App.tsx](../src/App.tsx)
- Remaining gap:
...
- Current product treatment:
  - quant indicator catalog in [research.ts](../src/data/research.ts)
  - spread-aware backtest mode in [backtest.ts](../src/lib/backtest.ts)
  - quant playbook panel in [App.tsx](../src/App.tsx)
- Remaining gap:
...
- Current status: partially implemented and strengthened in this round.
- Current product treatment:
  - local walk-forward model in [walk_forward_model.py](../python/walk_forward_model.py)
  - forecast band UI in [App.tsx](../src/App.tsx)
- Remaining gap:
...
- Current product treatment:
  - CSV backtest runner in [backtest.ts](../src/lib/backtest.ts)
  - desktop lab UI in [App.tsx](../src/App.tsx)
- Remaining gap:
...
- Current status: partially implemented and strengthened in this round.
- Current product treatment:
  - project boundary and truth rules in [AGENTS.md](../AGENTS.md)
  - product and research guidance in [product-strategy.md](product-strategy.md)
  - operating harness in [harness-engineering.md](harness-engineering.md)
- Remaining gap:
...
- Added a dedicated harness operating document in [harness-engineering.md](harness-engineering.md).
